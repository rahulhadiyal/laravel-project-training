...
<!-- jQuery -->
<script src="{{ asset('adminThemeplugins/jquery/jquery.min.js') }}"></script>
<!-- Bootstrap 4 -->
<script src="{{ asset('adminThemeplugins/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
<!-- AdminLTE App -->
<script src="{{ asset('adminThemedist/js/adminlte.min.js') }}"></script>
</body>
</html>
